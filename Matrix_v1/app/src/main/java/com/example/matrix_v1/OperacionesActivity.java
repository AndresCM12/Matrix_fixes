       ...
       SharedPreferences shar = getSharedPreferences("datos", context.MODE_PRIVATE);
        ...
        btnPasos.setOnClickListener(new View.OnClickListener(){
            public void onClick(View view) {
                ...
                pasos.putExtra("flagcomb", flagcomb);
                pasos.putExtra("determinante", determinante);
                pasos.putExtra("boton", boton);
                int flag = 0;
        ...
        switch (i){
            ...
            case (3):
                ...
                if(obtenerDatos != null) {
                    ...
                    if(flagcomb == 3 && boton ==1){
                        txtRenglonUno_1.setText(obtenerDatos[0] + "");
                        txtRenglonUno_2.setText(obtenerDatos[1] + "");
                        txtRenglonUno_3.setText(obtenerDatos[3] + "");
                        txtRenglonUno_a.setText("" + obtenerDatos[2]+"");

                        txtRenglonDos_1.setText(obtenerDatos[4] + "");
                        txtRenglonDos_2.setText(obtenerDatos[5] + "");
                        txtRenglonDos_3.setText(obtenerDatos[7] + "");
                        txtRenglonDos_b.setText(obtenerDatos[6] + "");
                    ...
                    if(txtRenglonUno_a.getText().toString().equals("0.0") && txtRenglonDos_b.getText().toString().equals("0.0") &&
                            txtRenglonTres_c.getText().toString().equals("0.0") && boton != 1){
                        txtRenglonUno_a.setVisibility(View.GONE);
                        txtRenglonDos_b.setVisibility(View.GONE);
                        txtRenglonTres_c.setVisibility(View.GONE);

                    }else if(flagcomb == 0){
                        txtRenglonTres_1.setVisibility(View.GONE);
                        txtRenglonTres_2.setVisibility(View.GONE);
                        txtRenglonTres_3.setVisibility(View.GONE);
                        txtRenglonTres_c.setVisibility(View.GONE);

                    }
                    else if(flagcomb == 2){
                        txtRenglonUno_a.setText("0.0");
